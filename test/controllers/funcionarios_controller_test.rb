...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference('Funcionario.count') do
      post funcionarios_url, params: { funcionario: { cargo_id: @funcionario.cargo_id, status_pagamento: @funcionario.status_pagamento, terceiro_id: @funcionario.terceiro_id } }, as: :json
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { cargo_id: @funcionario.cargo_id, status_pagamento: @funcionario.status_pagamento, terceiro_id: @funcionario.terceiro_id } }, as: :json
    assert_response 200
  end
